...
parser.add_argument(
    ...
    type=float,
    metavar="LR_B",
    help="backbone initial learning rate",
    dest="lr_b",
)
parser.add_argument(
    "--schedule",
...
parser.add_argument(
    "--cifar10",
    action="store_true",
    help="train classifier on cifar10",
)
parser.add_argument(
    "--cifar100",
    action="store_true",
    help="train classifier on cifar100",
)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for name, param in model.named_parameters():
        if name in ["fc.weight", "fc.bias"]:
            ...
            if args.pretrained:
                if args.lr_b:
                    parameters.append({'params': param, 'lr': args.lr_b})
                    print(name)
            else:
                parameters.append({'params': param, 'lr': args.lr})
                print(name)
    ...
    Cosine_scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=args.epochs)
